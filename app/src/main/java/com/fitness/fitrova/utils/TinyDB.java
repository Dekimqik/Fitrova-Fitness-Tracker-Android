...
public class TinyDB {
    ...
    public TinyDB(Context appContext) {
        preferences = PreferenceManager.getDefaultSharedPreferences(FTApp.getInstance());
    }
    ...
    public void putListObject(String key, ArrayList<Objects> objArray){
        checkForNullKey(key);
        Gson gson = new Gson();
...
//    public synchronized void putListTime(String key, ArrayList<CITime> objArray){
//        try {
//            checkForNullKey(key);
//            Gson gson = new Gson();
//            ArrayList<String> objStrings = new ArrayList<String>();
...
//            // not sure : ConcurrentModificationException
//            e.printStackTrace();
//        }
//    }
